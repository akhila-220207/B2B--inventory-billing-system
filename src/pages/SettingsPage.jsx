    ...
    <aside style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "'Georgia', serif", color: "#fff", fontSize: 17, fontWeight: 700 }}>
          Buyer<span style={{ color: "#3b82f6" }}>Panel</span>
        </span>
        <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 10, letterSpacing: 1, textTransform: "uppercase" }}>Buyer Account</div>
        </div>
      </div>
    </aside>
  );
...
export default function SettingsPage() {
  const [formData, setFormData] = useState(() => ({
    business: localStorage.getItem("userBusiness") || "Buyer Company",
    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <main style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: "rgba(255,255,255,0.5)", fontSize: 12 }}>
                {activeTab === "business" && "Update your business identity and billing details"}
                {activeTab === "contact" && "Keep your contact information up to date"}
                {activeTab === "security" && "Secure your buyer account"}
              </div>
            </div>
          </div>
        ...
        <div style={{ display: "flex", gap: 16, marginTop: 24, maxWidth: 680 }}>
          {[
            { icon: "✦", label: "Account Status", value: "Verified Buyer", color: "#16a34a", bg: "#f0fdf4" },
            { icon: "▦", label: "Purchased Items", value: "Active", color: "#2563eb", bg: "#eff6ff" },
            { icon: "☰", label: "Pending Orders", value: "Active", color: "#d97706", bg: "#fffbeb" },
          ].map(card => (
