...
title: "Product Management",
desc: "Manage products, categories and stock efficiently.",
},
{
icon: <FaClipboardList size={34} />,
title: "Order Management",
desc: "Track and manage all supplier and buyer orders.",
},
{
icon: <FaFileInvoice size={34} />,
title: "Billing & Invoices",
desc: "Generate GST invoices and manage payments.",
},
{
icon: <FaChartBar size={34} />,
title: "Reports & Analytics",
desc: "Visual dashboards with business insights.",
},
{
icon: <FaWarehouse size={34} />,
title: "Inventory Tracking",
desc: "Monitor stock levels with smart alerts.",
},
];

return ( <div className="min-h-screen flex flex-col bg-[#f1f5f9]">

```
  {/* Offer Bar */}
  <div className="bg-blue-600 text-white py-2 overflow-hidden">
    <div className="marquee whitespace-nowrap text-sm">
      🔥 Bulk Order Discounts | 🚚 Free Delivery Above ₹5000 | ⭐ Trusted by 500+ Businesses | 📦 10,000+ Products
    </div>
  </div>
...
<main
  className="flex items-center justify-center flex-1 px-12 py-24 bg-cover bg-center relative"
...
{/* Content */}
  ...
  <div className="relative z-10 max-w-2xl text-center space-y-6 text-white">

```
<h2 className="text-5xl font-bold">
  Smart B2B Inventory
  <span className="text-blue-400"> & Billing Platform</span>
</h2>

<p className="text-lg text-gray-200">
  Manage products, orders, billing and inventory in one powerful
  workspace designed for suppliers and buyers.
</p>
  ...
  <section className="py-16 bg-white">
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-3 lg:grid-cols-5 gap-6">
      ...
      {features.map((f, i) => (
        <div
          key={i}
          className="bg-[#f8fafc] p-6 rounded-xl shadow hover:shadow-lg transition text-center"
        >
